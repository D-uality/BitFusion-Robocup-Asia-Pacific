  ...
  // baseFunctions.cpp
    ...
    extern void setupDriveServos();
    extern void run(int v1, int v2, int delayTime=0);

    extern Adafruit_VL53L0X ToF[3];
    extern uint16_t distancesToF[3];
    extern void setupToF();
    extern void readToF(int sensor);

    extern Servo clawServo;
    extern const int clawServoPin;
    extern void clawIncrement(int position, int stepTime);
